...
travel(name: "Aiden", distance: 3.14159)
...
func describeSpeed(kph: Double) -> String {
    if kph > 30 {
        return ("Woah slow down buddy, \(kph) km/h is too fast")
    } else if kph > 0 {
        return ("We're moving \(kph) km/h")
    } else {
        return ("We're standing stil")
    }
}
...
// oh i already did that to the code above



// Test it by uncommenting the lines below:

var sd1 = describeSpeed(kph: 10)
var sd2 = describeSpeed(kph: 0)
var sd3 = describeSpeed(kph: 45)
